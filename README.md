...
- [Описание](📖%20Описание)
- [Установка и запуск](🛠️%20Установка%20и%20запуск)
    * [Установка с помощью Docker](🔹%20I.%20Установка%20с%20помощью%20Docker%20(лёгкий%20способ))
    * [Установка с помощью Git](🔶%20II.%20Установка%20с%20помощью%20Git%20(сложный%20способ))
- [Как пользоваться](🚀%20Как%20пользоваться)
- [Перед началом работы](📚%20Перед%20началом%20работы%20(полезные%20файлы))
