...
- [📖Описание](#📖-описание)
- [🛠️Установка и запуск](🛠️-установка-и-запуск)
    * [🔹 Установка с помощью Docker](#-🔹-установка-с-помощью-docker-лёгкий-способ)
    * [🔶 Установка с помощью Git](#🔶установка-с-помощью-git-сложный-способ)
- [🚀Как пользоваться](#🚀-как-пользоваться)
- [📚 Перед началом работы](#-📚-перед-началом-работы-полезные-файлы)
